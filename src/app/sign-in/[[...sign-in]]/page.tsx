...
/*The clerk elements for some reason dosent work when you upgrade to the latest Clerk
I need to contact Clerk to learn more about whats happenning for now I can either downgrade or not use the clerk elements download
The error was caused by the clerk element version sometimes downgrading or upgrading versions can help fix errors*/
...
//                   formButtonPrimary: 
//                     "w-full rounded-md bg-neutral-600 hover:bg-neutral-700 px-4 py-2 text-sm font-semibold text-white shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-neutral-600",
//                   formFieldInput: 
//                     "block w-full rounded-md border-0 py-1.5 text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 placeholder:text-neutral-400 focus:ring-2 focus:ring-inset focus:ring-neutral-600 sm:text-sm sm:leading-6",
//                   formFieldLabel: "block text-sm font-medium leading-6 text-neutral-900 mb-2",
//                   footer: "hidden",
//                   header: "hidden",
//                   socialButtonsProviderIcon: "h-5 w-5",
//                   socialButtonsBlockButton: 
//                     "w-full rounded-md bg-white px-4 py-2 text-sm font-semibold text-neutral-900 shadow-sm ring-1 ring-inset ring-neutral-300 hover:bg-neutral-50",
//                   dividerLine: "bg-neutral-200",
//                   dividerText: "text-sm text-neutral-500 bg-white px-2",
//                 },
//                 layout: {
